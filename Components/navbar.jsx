        ...
        <>
            ...
            <aside className={style.left_header}>
                ...
                <div className={`${style.left_header_social}`}>
                    <ul>
                        <li>
                            <a href="https://twitter.com/Somaxmaritime?s=08" target="_blank">
                                <svg
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/somax-maritime-consulting-a860b81ab" target="_blank">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width={16}
                                    height={16}
                        ...
                        <li>
                            <a
                                href="https://instagram.com/somaxvnz?igshid=1kkfzvpk4jqbh"
                                target="_blank"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
